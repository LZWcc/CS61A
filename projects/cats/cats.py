...
def about(keywords):
    ...
    def contain(paragraph):
        tmp = split(remove_punctuation(paragraph))
        for word in tmp:
...
def accuracy(typed, source): # typed 键入单词 source 总输入单词
